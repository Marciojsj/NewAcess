...
const styles: { [key: string]: ViewStyle | TextStyle } = {
	...
	header: { paddingHorizontal: responsive.padding.md, paddingTop: responsive.padding.sm, paddingBottom: responsive.padding.md },
	headerDesktop: { paddingTop: responsive.padding.lg, paddingBottom: responsive.padding.xl },
	headerTop: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' as const },
	greetingContainer: { flex: 1 },
	greeting: { fontSize: responsive.fontSize.lg, fontWeight: '700' as const, color: '#fff' },
	greetingDesktop: { fontSize: responsive.fontSize.xxl },
	accountType: { fontSize: responsive.fontSize.sm, color: '#aaa' },
	accountTypeDesktop: { fontSize: responsive.fontSize.md },
	...
	quickActionsContainer: { marginVertical: responsive.spacing.lg },
	quickActionsContainerDesktop: { marginVertical: responsive.spacing.xl },
	quickActionsScroll: { paddingHorizontal: responsive.padding.md, ...(deviceType.isDesktop && { justifyContent: 'center', flexGrow: 1 }) },
	quickActionButton: { width: 80, height: 80, borderRadius: 24, justifyContent: 'center', alignItems: 'center', elevation: 8, shadowColor: '#000', shadowOffset: { width: 0, height: 5 }, shadowOpacity: 0.3, shadowRadius: 8 },
	quickActionIcon: { fontSize: 28, marginBottom: 6 },
	quickActionTitle: { fontSize: 12, fontWeight: '600' as const, color: '#fff', textAlign: 'center' },
	serviceCardsContainer: { marginBottom: 1 },
	sectionTitle: { fontSize: responsive.fontSize.md, fontWeight: '600' as const, color: '#fff', paddingHorizontal: responsive.padding.md, marginBottom: responsive.spacing.md },
	sectionTitleDesktop: { fontSize: responsive.fontSize.lg, marginBottom: responsive.spacing.lg },
	serviceCardsGrid: { flexDirection: 'row', flexWrap: 'wrap' as const, justifyContent: 'space-between', paddingHorizontal: responsive.padding.xs, alignItems: 'stretch' as const },
